...
if (typeof gemius_hcconn == "undefined") {
	gemius_hcconn = {
		...
		hc : (typeof gemius_hitcollector != 'undefined')?gemius_hitcollector:(typeof pp_gemius_hitcollector != 'undefined')?pp_gemius_hitcollector:'spir.hit.gemius.pl',
		...
		parameters : function() {
			...
			try { if (ref=="" && typeof ia_document != "undefined" && ia_document.referrer) ref=new String(ia_document.referrer);} catch(e) {}
