...
if(g&&g[1]){var m=g[1].replace(/\d+$/,""),k=c[m];if(k){for(var u=0;u<k.stats.length;u++){var v=k.stats[u];e[k.prefix+v.prefix]=Math.round(d[v.name])}delete c[m];if(!J(c))break}}}}var l=e;break a}catch(n){}l=void 0}if(l&&J(l))return l}function Q(b,c){var e,f=window._dv_win.document.visibilityState;window[b.tagObjectCallbackName]=function(d){var g=window._dv_win.$dvbs;if(g){var m=c?"https:":M();e=d.ImpressionID;g.tags.add(d.ImpressionID,b);g.tags[d.ImpressionID].set({tagElement:b.script,impressionId:d.ImpressionID,
...
e=b.innerHTML.replace(f,"\x3c/script>");b=d(b);b.hasPassback=!0;return b}return{isBadImp:!0,hasPassback:!1,tagAdTag:c,tagPassback:e}};return d(b)}function K(b,c,e,f,d,g,m,k,u,v){var l;void 0==c.dvregion&&(c.dvregion=0);try{var n=f;for(l=0;10>l&&n!=window._dv_win.top;)l++,n=n.parent;f.depth=l;var h=S(f);var r="&aUrl="+encodeURIComponent(h.url);var A="&aUrlD="+h.depth;var C=f.depth+d;g&&f.depth--}catch(D){A=r=C=f.depth=""}void 0!=c.aUrl&&(r="&aUrl="+c.aUrl);a:{try{if("object"==typeof window.$ovv||"object"==
...
verRegex:null},{id:3,brRegex:"Chrome",verRegex:"Chrome/"},{id:5,brRegex:"Safari|(OS |OS X )[0-9].*AppleWebKit",verRegex:"Version/"}];g=0;n="";for(h=0;h<l.length;h++)if(null!=p.match(new RegExp(l[h].brRegex))){g=l[h].id;if(null==l[h].verRegex)break;p=p.match(new RegExp(l[h].verRegex+"[0-9]*"));null!=p&&(n=p[0].match(new RegExp(l[h].verRegex)),n=p[0].replace(n[0],""));break}l=h=T();n=h===g?n:"";window._dv_win.$dvbs.CommonData.BrowserId=l;window._dv_win.$dvbs.CommonData.BrowserVersion=n;window._dv_win.$dvbs.CommonData.BrowserIdFromUserAgent=
...
(c+="&"+f);if(!1===k||u)c=c+("&dvp_isBodyExistOnLoad="+(k?"1":"0"))+("&dvp_isOnHead="+(u?"1":"0"));e="srcurl="+encodeURIComponent(e);if((k=window._dv_win[H("=@42E:@?")][H("2?46DE@C~C:8:?D")])&&0<k.length){u=[];u[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(f=0;f<k.length;f++)u[f+1]=k[f];k=u.reverse().join(",")}else k=null;k&&(e+="&ancChain="+encodeURIComponent(k));k=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&7>=new Number(RegExp.$1)&&(k=2E3);if(d=dv_GetParam(d,
"referrer"))d="&referrer="+d,c.length+d.length<=k&&(c+=d);r.length+A.length+c.length<=k&&(c+=A,e+=r);(r=V())&&(c+="&m1="+r);(r=W())&&0<r.f&&(c+="&bsig="+r.f,c+="&usig="+r.s);r=c;try{var x="&fcifrms="+window.top.length;window.history&&(x+="&brh="+window.history.length);var q=L(),B=q.document;if(q==window.top){x+="&fwc="+((q.FB?1:0)+(q.twttr?2:0)+(q.outbrain?4:0)+(q._taboola?8:0));try{B.cookie&&(x+="&fcl="+B.cookie.length)}catch(D){}q.performance&&q.performance.timing&&0<q.performance.timing.domainLookupStart&&
...
g=["Moz","O","ms","Webkit"],m=["moz","o","ms","webkit"],k={style:d("modernizr").style},u=function(b,c){function g(){f&&(delete k.style,delete k.modElem)}var e;for(e=["modernizr","tspan","samp"];!k.style&&e.length;){var f=!0;k.modElem=d(e.shift());k.style=k.modElem.style}var l=b.length;for(e=0;e<l;e++){var m=b[e];~(""+m).indexOf("-")&&(m=cssToDOM(m));if(void 0!==k.style[m])return g(),"pfx"==c?m:!0}g();return!1},v=function(b,c,d){var f=b.charAt(0).toUpperCase()+b.slice(1),k=(b+" "+g.join(f+" ")+f).split(" ");
if("string"===typeof c||"undefined"===typeof c)return u(k,c);k=(b+" "+m.join(f+" ")+f).split(" ");for(var l in k)if(k[l]in c){if(!1===d)return k[l];b=c[k[l]];return"function"===typeof b?e(b,d||c):b}return!1};c(0,!0);c(1,v("requestFileSystem",window));c(2,window.CSS?"function"==typeof window.CSS.escape:!1);c(3,v("shapeOutside","content-box",!0));return b}catch(l){return 0}}function L(){var b=window,c=0;try{for(;b.parent&&b!=b.parent&&b.parent.document&&!(b=b.parent,10<c++););}catch(e){}return b}function W(){try{var b=
...
4+2)/16),f=Array(e),n=0;n<e;n++){f[n]=Array(16);for(var h=0;16>h;h++)f[n][h]=b.charCodeAt(64*n+4*h)<<24|b.charCodeAt(64*n+4*h+1)<<16|b.charCodeAt(64*n+4*h+2)<<8|b.charCodeAt(64*n+4*h+3)}f[e-1][14]=8*(b.length-1)/Math.pow(2,32);f[e-1][14]=Math.floor(f[e-1][14]);f[e-1][15]=8*(b.length-1)&4294967295;b=1732584193;h=4023233417;var r=2562383102,A=271733878,C=3285377520,t=Array(80);for(n=0;n<e;n++){for(var p=0;16>p;p++)t[p]=f[n][p];for(p=16;80>p;p++)t[p]=c(t[p-3]^t[p-8]^t[p-14]^t[p-16],1);var w=b;var y=
h;var x=r;var q=A;var B=C;for(p=0;80>p;p++){var z=Math.floor(p/20),D=c(w,5);a:{switch(z){case 0:var E=y&x^~y&q;break a;case 1:E=y^x^q;break a;case 2:E=y&x^y&q^x&q;break a;case 3:E=y^x^q;break a}E=void 0}z=D+E+B+g[z]+t[p]&4294967295;B=q;q=x;x=c(y,30);y=w;w=z}b=b+w&4294967295;h=h+y&4294967295;r=r+x&4294967295;A=A+q&4294967295;C=C+B&4294967295}return d(b)+d(h)+d(r)+d(A)+d(C)}function c(){try{return!!window.sessionStorage}catch(g){return!0}}function e(){try{return!!window.localStorage}catch(g){return!0}}
...
c()?"1":"0"]);d.push(["hls",e()?"1":"0"]);d.push(["odb",typeof window.openDatabase||""]);d.push(["cpu",navigator.cpuClass||""]);d.push(["pf",navigator.platform||""]);d.push(["dnt",navigator.doNotTrack||""]);d.push(["canv",f()]);return b(d.join("=!!!="))}catch(g){return null}}this.createRequest=function(){var b=!1,c=window._dv_win,e=0,f=!1,d;try{for(d=0;10>=d;d++)if(null!=c.parent&&c.parent!=c)if(0<c.parent.location.toString().length)c=c.parent,e++,b=!0;else{b=!1;break}else{0==d&&(b=!0);break}}catch(r){b=
!1}0==c.document.referrer.length?b=c.location:b?b=c.location:(b=c.document.referrer,f=!0);if(!window._dv_win.dvbsScriptsInternal||!window._dv_win.dvbsProcessed||0==window._dv_win.dvbsScriptsInternal.length)return{isSev1:!1,url:null};var g=window._dv_win.dv_config&&window._dv_win.dv_config.isUT?window._dv_win.dvbsScriptsInternal[window._dv_win.dvbsScriptsInternal.length-1]:window._dv_win.dvbsScriptsInternal.pop();d=g.script;this.dv_script_obj=g;this.dv_script=d;window._dv_win.dvbsProcessed.push(g);
window._dv_win._dvScripts.push(d);var m=d.src;this.dvOther=0;this.dvStep=1;var k=window._dv_win.dv_config?window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():F():F();g=window.parent.postMessage&&window.JSON;var u=!0,v=!1;if("0"==dv_GetParam(m,"t2te")||window._dv_win.dv_config&&1==window._dv_win.dv_config.supressT2T)v=!0;if(g&&0==v)try{var l=I(window._dv_win.dv_config.bst2turl||"https://cdn3.doubleverify.com/bst2tv3.html",
"bst2t_"+k);u=G(l)}catch(r){}l={};try{v=/[\?&]([^&]*)=([^&#]*)/gi;for(var n=v.exec(m);null!=n;)"eparams"!==n[1]&&(l[n[1]]=n[2]),n=v.exec(m);var h=l}catch(r){h=l}h.perf=this.perf;h.uid=k;h.script=this.dv_script;h.callbackName="__verify_callback_"+h.uid;h.tagObjectCallbackName="__tagObject_callback_"+h.uid;h.tagAdtag=null;h.tagPassback=null;h.tagIntegrityFlag="";h.tagHasPassbackFlag="";0==(null!=h.tagformat&&"2"==h.tagformat)&&(n=R(h.script),h.tagAdtag=n.tagAdTag,h.tagPassback=n.tagPassback,n.isBadImp?
h.tagIntegrityFlag="&isbadimp=1":n.hasPassback&&(h.tagHasPassbackFlag="&tagpb=1"));(n=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream)?l="https:":(l=h.script.src,m="http:",k=window._dv_win.location.toString().match("^http(?:s)?"),"https"!=l.match("^https")||"https"!=k&&"http"==k||(m="https:"),l=m);h.protocol=l;h.ssl="0";"https:"===h.protocol&&(h.ssl="1");l=h;(m=window._dv_win.dvRecoveryObj)?
("2"!=l.tagformat&&(m=m[l.ctx]?m[l.ctx].RecoveryTagID:m._fallback_?m._fallback_.RecoveryTagID:1,1===m&&l.tagAdtag?document.write(l.tagAdtag):2===m&&l.tagPassback&&document.write(l.tagPassback)),l=!0):l=!1;if(l)return{isSev1:!0};this.dvStep=2;Q(h,n);d=d&&d.parentElement&&d.parentElement.tagName&&"HEAD"===d.parentElement.tagName;this.dvStep=3;return K(this,h,b,c,e,f,g,u,d,n)};this.sendRequest=function(b){var c=dv_GetParam(b,"tagformat");c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,document.body):
dv_sendScriptRequest(b);try{var e=N(this.dv_script_obj&&this.dv_script_obj.injScripts),f=I("about:blank");f.id=f.name;var d=f.id.replace("iframe_","");f.setAttribute&&f.setAttribute("data-dv-frm",d);G(f,this.dv_script);if(this.dv_script){var g=this.dv_script;a:{b=null;try{if(b=f.contentWindow){var m=b;break a}}catch(v){}try{if(b=window._dv_win.frames&&window._dv_win.frames[f.name]){m=b;break a}}catch(v){}m=null}g.dvFrmWin=m}var k=O(f);if(k)k.open(),k.write(e);else{try{document.domain=document.domain}catch(v){}var u=
...
K);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"98"}};
