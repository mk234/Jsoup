(function () {
    ...
    var Loader = {
        base: (location.protocol.match(/^https/i) ? "https:" : "http:") + "//api.mapy.cz",
        mode: "single",
        version: "4.13.13",
        async: false,
        ...
        _files: {
            ...
            multi: {
                ...
                api: [
                    ...
                    "/js/api/v4/util/open-location-code.js",
        ...
        load: function (key_, what_, callback) {
            ...
            if (what.jak && !window.JAK && list.indexOf(files["api-jak"][0]) == -1) {
                list = list.concat(files.jak);
            }
