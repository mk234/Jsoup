...
if (typeof gemius_hcconn == "undefined") {
	gemius_hcconn = {
		...
		hc : (typeof pp_gemius_hitcollector != 'undefined')?pp_gemius_hitcollector:(typeof gemius_hitcollector != 'undefined')?gemius_hitcollector:'gacz.hit.gemius.pl',
		...
		msgreceiver : function(e) {
			if (e.data && e.data.substr && e.data.substr(0,15)=="_xx_gemius_xx_/") {
				if (gemius_hcconn.fto!=null) {
